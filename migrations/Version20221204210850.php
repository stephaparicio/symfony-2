 ...
 */
final class Version20221204210850 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE episode ADD season_id_id INT NOT NULL, ADD title VARCHAR(255) NOT NULL, ADD number INT NOT NULL, ADD synopsis LONGTEXT NOT NULL');
        ...
        $this->addSql('ALTER TABLE season ADD program_id_id INT NOT NULL, ADD number INT NOT NULL, ADD year INT NOT NULL, ADD description LONGTEXT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE season DROP program_id_id, DROP number, DROP year, DROP description');
